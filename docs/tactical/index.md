...
as post-processing using the [`postprocessing_tactical.py`](https://github.com/UoW-ATM/MultiModX/blob/main/performance_indicators/postprocessing_tactical.py)
provided as part of the [Performance Indicators](../performance_indicators/index.md#tactical-indicators).
